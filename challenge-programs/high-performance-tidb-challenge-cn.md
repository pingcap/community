...
1. **报名选题组队（2020.09.16-）**
   ...
   固定场景优化方向：请仔细阅读「[活动规则](#活动规则)」并填写报名表单，可从如下固定场景题目列表中选取一个。
...
2. 性能相关高难度 issue 方向：请仔细阅读「[活动规则](#活动规则)」并填写报名表单选择对应 issue
...
1. **WG 组长提交分支地址（针对固定场景优化小组）**

以 9.16 日 24:00 的 TiDB master 版本作为基准，WG 小组组长需在提交报名后 5 个工作日内提交一个基于此版本的分支。
