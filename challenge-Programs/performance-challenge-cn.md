...
Performance Challenge Program 是面向 TiDB&TiKV 开源社区的全新社区活动，之前在社区的贡献暂时不能与 Performance Challenge Program 积分的方式呈现，不过 Active Contributor 及以上个人参赛选手可以直接选择 Medium 及以上的 Issue 进行挑战。
