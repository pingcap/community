...
### Q2：如何放弃/变更已领取的任务？
放弃任务：在已领取任务对应 issue 下回复 “give-up-challenge”

变更任务：先对已领取的任务执行“放弃任务”操作，再选择新的任务

### Q3：之前在社区的贡献如何与 Performance Challenge Program 相结合？
Performance Challenge Program 是面向 TiDB&TiKV 开源社区的全新社区活动，之前在社区的贡献暂时不能与 Performance Challenge Program 积分的方式呈现，不过 Active Contributor 及以上个人参赛选手可以直接选择 Medium 及以上的题目进行挑战。
